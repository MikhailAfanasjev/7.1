...
public class GraphDemoFrame extends JFrame {
    ...
    private JButton buttonFindUnreachable;
    ...
    private static List<Integer> unreachableNodeList = new ArrayList<>();
    ...
    private static class SvgPanel extends JPanel {
        ...
        public void paint(String svg) throws IOException {
            ...
            if (!unreachableNodeList.equals(null) || !unreachableNodeList.isEmpty()) {
                changeColorOfElement(new Color(160, 150, 0), doc, "ellipse", unreachableNodeList);
            }
         ...
         */
        private static void changeColorOfElement(final Color color, final SVGDocument document, final String elementName, List<Integer> unreachableNodeList) {
            NodeList nodes = document.getElementsByTagName(elementName);
            for (int i = 0; i < nodes.getLength(); i++) {
                if (nodes.item(i) instanceof SVGElement) {
                    if (unreachableNodeList.contains(i)) {
    ...
    public GraphDemoFrame() {
        ...
        buttonFindUnreachable.addActionListener(e -> {
            try {
                String name = comboBoxGraphType.getSelectedItem().toString();
                Matcher matcher = Pattern.compile(".*\\W(\\w+)\\s*\\)\\s*$").matcher(name);
                matcher.find();
                ...
                unreachableNodeList = reachable.findUnreachable(GraphDemoFrame.this.graph, Integer.valueOf(textField1.getText()));
                String unreachable = "";
                for (Integer integer : unreachableNodeList) {
                    unreachable += integer + " ";
                }
                textField2.setText(unreachable);
                panelGraphPainter.paint(dotToSvg(graph.toDot()));
            } catch (Exception exc) {
                SwingUtils.showErrorMessageBox(exc);
            }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        panel1.add(panel7, new GridConstraints(3, 0, 1, 2, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        buttonFindUnreachable = new JButton();
        buttonFindUnreachable.setText("Найти недостижимые");
        panel7.add(buttonFindUnreachable, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        textField1 = new JTextField();
        panel7.add(textField1, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
        final JLabel label2 = new JLabel();
        label2.setText("Вершина:");
        ...
        label3.setText("Недостижимые вершины:");
        ...
        panel13.add(spacer10, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
    }
